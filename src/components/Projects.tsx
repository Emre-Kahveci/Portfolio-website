...
// Public projects - GitHub repos available and working
...
// Private projects - source code not shareable (Miyosis API and Tetris)
const privateProjects: ProjectData[] = [
    {
        slug: "MiyosisAPI",
        titleEn: "Miyosis API",
        titleTr: "Miyosis API",
...
// Inline style for text selection
...
function ProjectCard({ project, index, isInView, isEnglish, showViewCode, viewCodeText }: ProjectCardProps) {
    return (
        <motion.article
        ...
        >
            ...
            <div className="p-6" style={selectableStyle}>
                ...
                {/* View Code link - only for public projects */}
                {showViewCode && project.githubUrl && (
                    <a
...
export function Projects() {
    ...
    const viewCodeText = t("projects.viewCode");
    ...
    return (
        <section id="projects" className="section">
            <div className="max-w-7xl mx-auto" ref={ref}>
                ...
                >
                    <h2 className="section-title text-gradient">{t("projects.privateTitle")}</h2>
                    <p className="section-subtitle">{t("projects.privateSubtitle")}</p>
                </motion.div>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {privateProjects.map((project, index) => (
                        <ProjectCard
                            key={project.slug}
                            project={project}
                            index={index + publicProjects.length}
                            isInView={isInView}
                            isEnglish={isEnglish}
                            showViewCode={false}
                            viewCodeText={viewCodeText}
